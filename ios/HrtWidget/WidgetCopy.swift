...
struct WidgetCopy {
    ...
    var now: String { relative(DateComponents(second: 0), abbreviated: true) }
    ...
    private static let english = Words(
        ...
        late: "Late", noPlan: "No plan", noSchedule: "No schedule",
        future: "in %@", past: "%@ ago"
    )
